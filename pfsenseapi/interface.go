...
type Interface struct {
	...
	AdvDhcpPtTimeout                OptionalJSONInt `json:"adv_dhcp_pt_timeout,omitifempty"`
	AdvDhcpPtRetry                  OptionalJSONInt `json:"adv_dhcp_pt_retry,omitifempty"`
	AdvDhcpPtSelectTimeout          OptionalJSONInt `json:"adv_dhcp_pt_select_timeout,omitifempty"`
	AdvDhcpPtReboot                 OptionalJSONInt `json:"adv_dhcp_pt_reboot,omitifempty"`
	AdvDhcpPtBackoffCutoff          OptionalJSONInt `json:"adv_dhcp_pt_backoff_cutoff,omitifempty"`
	AdvDhcpPtInitialInterval        OptionalJSONInt `json:"adv_dhcp_pt_initial_interval,omitifempty"`
	...
	Subnet                          OptionalJSONInt `json:"subnet,omitifempty"`
	...
	Dhcpcvpt                        OptionalJSONInt `json:"dhcpcvpt,omitifempty"`
	...
	Mss                             string          `json:"mss"`
	Mtu                             OptionalJSONInt `json:"mtu,omitifempty"`
	Prefix6Rd                       string          `json:"prefix-6rd"`
	Prefix6RdV4Plen                 OptionalJSONInt `json:"prefix-6rd-v4plen,omitifempty"`
	Subnetv6                        string          `json:"subnetv6"`
	Track6Interface                 string          `json:"track6-interface"`
	Track6PrefixIdHex               OptionalJSONInt `json:"track6-prefix-id-hex,omitifempty"`
